...
public class MetaInfHandler extends AbstractVirtualFileHandler implements StructuredVirtualFileHandler {
	
	public MetaInfHandler(RailsAppContext vfsContext) {
		super( vfsContext, vfsContext.getWarRootHandler(), "META-INF" );
		System.err.println( "MetaInfHandler: "+ this );
		try {
			System.err.println( "MetaInfParent: " + getParent() );
		} catch (IOException e) {
	...
	public List<VirtualFileHandler> getChildren(boolean ignoreErrors) throws IOException {
		...
		children.add( getRailsAppContext().getJBossRailsYml() );
		return children;
	}
