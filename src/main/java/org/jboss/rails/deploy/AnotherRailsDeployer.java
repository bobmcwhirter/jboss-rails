...
public class AnotherRailsDeployer extends AbstractDeployer
// implements RailsDeployerMBean
{
	...
	public AnotherRailsDeployer() {
		setStage(DeploymentStages.PARSE);
		//setOutput(WebMetaData.class);
		setOutput(VFSDeploymentUnit.class);
		setAllInputs(true);
	}
	...
	private void deployRailsWar(VFSDeploymentUnit unit, VirtualFile warRoot) throws DeploymentException {
		...
		//VFSDeploymentFactory.getInstance().
		//unit.getTransientManagedObjects().addAttachment(VFSDeploymentUnit.class, warDeployment);
		//WebMetaData md = new WebMetaData();

		//md.setDistributable(distributable)
