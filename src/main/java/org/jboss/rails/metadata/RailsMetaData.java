...
public class RailsMetaData {
	 ...
	 * 
	 * <p>
	 * The default environment of 'development' is used until/unless otherwise set.
	 * </p>
	 */
	 ...
	 * 
	 * <p>
	 * The application-name, if not set, is derived from the directory
	 * or symlink name from the deploy/ directory.
	 * </p>
	 * 
	 ...
	 * 
	 * @param applicationName Defines the name of the application, for the deployment context.
	 */
	 ...
	 * 
	 * @param environment The RAILS_ENV environment.
	 */
	 ...
	 * 
	 * @param railsRoot The RAILS_ROOT filesystem path.
	 */
